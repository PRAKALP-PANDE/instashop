        ...
        <section className="text-gray-600 body-font overflow-hidden">
            <div className="container px-5 py-16 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/81HjJIBgKgL._AC_SX466_.jpg" />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h2 className="text-sm title-font text-gray-500 tracking-widest">InstaShop</h2>
                        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Hoodie (XL, Aqua Green)</h1>
                        ...
                        <div className="flex">
                            <span className="title-font font-medium text-2xl text-gray-900">₹598.00</span>
                            ...
                            <button onClick={() => {addToCart(slug, 1, 598, 'Tshirt', 'XL', "RED")}} className="flex ml-4 text-white bg-green-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-green-600 rounded">Add to Cart</button>
